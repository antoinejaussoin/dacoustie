...
$loading_img = '&nbsp;&nbsp;<img id="imgLoading" border="0" src="'.JURI::root().'components/com_aicontactsafe/includes/images/load.gif" />&nbsp;&nbsp;';
		...
		$('adminForm_'+pf).addEvent('submit', function(e) {
			...
			this.send({
				onRequest: function(){ 
										...
										document.getElementById('adminForm_'+pf).elements['aiContactSafeSendButton'].value = '".str_replace("'","\'",JText::_( 'Please wait ...' ))."'; 
										document.getElementById('adminForm_'+pf).elements['aiContactSafeSendButton'].disabled = true;
									},
				onComplete: function() { 
										$('displayAiContactSafeForm_'+pf).setHTML( this.response.text );
										changeCaptcha(pf,0); 
										document.getElementById('adminForm_'+pf).elements['aiContactSafeSendButton'].value = '".str_replace("'","\'",JText::_( 'Send' ))."'; 
