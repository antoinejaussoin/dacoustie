...
<fieldset class="adminform">
	...
	<table id="control_panel">
		...
		<tr>
			<td class="key">
				<font color="#FF0000"><?php echo JText::_( 'Delete database tables' ); ?></font>
			</td>
			<td class="space">&nbsp;</td>
			<td class="value">
				<button onclick="document.getElementById('task').value='confirm_delete_all';this.form.submit();"><?php echo JText::_( 'Go' ); ?></button>&nbsp;&nbsp;&nbsp;<font color="#FF0000"><?php echo JText::_( 'DO_NOT_USE' ); ?></font>
			</td>
		</tr>
	</table>
</fieldset>
