...
class AiContactSafeModelMessages extends AiContactSafeModelDefault {
	...
	function generateCSV() {
		...
		$query = 'SELECT m.*, p.name as profile FROM #__aicontactsafe_messages m LEFT JOIN #__aicontactsafe_profiles p ON m.profile_id = p.id '.$where;
		$db->setQuery($query);
