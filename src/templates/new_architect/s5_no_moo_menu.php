...
function mosGetLink( $mitem, $level, $class_sfx='' ) {
  ...
  if ($mitem->cnt > 0) {
		...
		$random = (rand()%30000000000000);
		    if ($level == 0) {
			$LiveSite = JURI::base();
                $txt = "<span class=\"s5_outer_active\"><span style=\"background-image: url('".$LiveSite."images/stories/". $menu_image ."')\" class=\"s5_rs\"><a class=\"active\" href=\"$mitem->link\">$mitem->name<span class=\"s5_bottom_text\"></span></a></span></span>";
								$main = "main";
		   } else {
...
if ($level == 0) {
$LiveSite = JURI::base();
		   $txt = "<span class=\"s5_outer_active\"><span style=\"background-image: url('images/stories/". $menu_image ."')\" class=\"s5_rs\"><a class=\"active\" href=\"$mitem->link\">$mitem->name<span class=\"s5_bottom_text\"></span></a></span></span>";

}

else if ($level > 0) {
$LiveSite = JURI::base();
		   $txt = "<span><span style=\"background-image: url('".$LiveSite."images/stories/". $menu_image ."')\" class=\"s5_rs\"><a class=\"sub\" href=\"$mitem->link\">$mitem->name</a></span></span>";
...
function mosShowListMenu($menutype) {
	...
	$indents = array(
			...
			array( "\t\t<ul><li class='s5_toparrow'></li>", "\t\t\t<li class='noback'>" , '</li>', "\t\t<li class='s5_menubottom'></li></ul>" ),
			array( "\t\t<ul>", "\t\t\t<li>" , '</li>', "\t\t<li class='s5_menubottom'></li></ul>" ),
			array( "\t\t\t<ul>", "\t\t\t\t<li>" , '</li>', "\t\t\t<li class='s5_menubottom'></li></ul>" ),
			array( "\t\t\t\t<ul>", "\t\t\t\t\t<li>" , '</li>', "\t\t\t\t<li class='s5_menubottom'></li></ul>" ),
	);
	$children = array();
