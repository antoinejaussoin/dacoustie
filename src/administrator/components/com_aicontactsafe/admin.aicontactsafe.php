...
if ($sTask == 'default' or $sTask == '' or ( $sTask != 'messages' && $sTask != 'profiles' && $sTask != 'fields' && $sTask != 'control_panel' && $sTask != 'about' )){
	$sTask = 'messages';
}
...
function setSubMenu($sTask = '') {
	JSubMenuHelper::addEntry(JText::_('Messages'), 'index.php?option=com_aicontactsafe&sTask=messages', $sTask == 'messages');
	JSubMenuHelper::addEntry(JText::_('Profiles'), 'index.php?option=com_aicontactsafe&sTask=profiles', $sTask == 'profiles');
	JSubMenuHelper::addEntry(JText::_('Fields'), 'index.php?option=com_aicontactsafe&sTask=fields', $sTask == 'fields');
	JSubMenuHelper::addEntry(JText::_('Control panel'), 'index.php?option=com_aicontactsafe&sTask=control_panel', $sTask == 'control_panel');
	JSubMenuHelper::addEntry(JText::_('About'), 'index.php?option=com_aicontactsafe&sTask=about', $sTask == 'about');
}
