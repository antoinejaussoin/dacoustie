...
<thead>
	<tr>
		...
		<th width="220" nowrap="nowrap">
			<?php echo JHTML::_('grid.sort', JText::_( 'Field label' ), 'field_label', @$this->filter_order_Dir, @$this->filter_order ); ?>
		</th>
		<th width="220" nowrap="nowrap">
			<?php echo JHTML::_('grid.sort', JText::_( 'Field label in message' ), 'field_label_message', @$this->filter_order_Dir, @$this->filter_order ); ?>
		</th>
	...
	<?php
		...
		foreach($this->rows as $row) {
			...
			<tr class="row<?php echo $k; ?>">
				...
				<td align="left"><?php echo $row->field_label_message; ?></td>
